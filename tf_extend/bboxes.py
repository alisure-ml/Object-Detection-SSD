...
from tf_extend import tensors as tfe_tensors
from tf_extend import math as tfe_math
...
def bboxes_matching_batch(labels, scores, bboxes, glabels, gbboxes, gdifficults, matching_threshold=0.5, scope=None):
    """Matching a collection of detected boxes with groundtruth values.
...
# =========================================================================== #
def bboxes_filter_center(labels, bboxes, margins=list([0., 0., 0., 0.]), scope=None):
...
def bboxes_filter_overlap(labels, bboxes, threshold=0.5, assign_negative=False, scope=None):
    """
...
def bboxes_filter_labels(labels, bboxes, out_labels=list([]), num_classes=np.inf, scope=None):
